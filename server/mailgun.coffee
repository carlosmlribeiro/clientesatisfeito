...
sendEmail = (user, template, tag) ->
	...
	params:
		...
		subject: "Bem vindo ao Cliente Satisfeito"
		text: "Bem vindo\n http://clientesatisfeito.pt \nObrigado \nGrande abraço! \n\nTo unsubscribe from all communications click: <%unsubscribe_url%>"
		o:tag: tag,
		#o:testmode: 'yes',
	(err, result) ->
		if err
